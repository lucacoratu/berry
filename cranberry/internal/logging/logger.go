...
func NewLogger(infoPrefix string, warningPrefix string, errorPrefix string, fatalPrefix string) *Logger {
	...
	return &Logger{InternalLogger: log.New(os.Stdout, "[CRANBERRY] - ", log.Ldate|log.Ltime), InfoPrefix: infoPrefix, WarningPrefix: warningPrefix, ErrorPrefix: errorPrefix, FatalPrefix: fatalPrefix, DebugEnabled: false, DebugPrefix: ""}
}
...
func NewDebugLogger(infoPrefix string, warningPrefix string, errorPrefix string, fatalPrefix string, debugPrefix string) *Logger {
	return &Logger{InternalLogger: log.New(os.Stdout, "[CRANBERRY] - ", log.Ldate|log.Ltime), InfoPrefix: infoPrefix, WarningPrefix: warningPrefix, ErrorPrefix: errorPrefix, FatalPrefix: fatalPrefix, DebugEnabled: true, DebugPrefix: debugPrefix}
}

func NewDefaultLogger() *Logger {
	return &Logger{
		InternalLogger: log.New(os.Stdout, "[CRANBERRY] - ", log.Ldate|log.Ltime),
